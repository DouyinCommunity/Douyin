namespace Douyin.FFME.Windows
{
    ...
    public partial class App
    {
        ...
        public App()
        {
            ...
            Library.FFmpegDirectory = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"ffmpeg" + (Environment.Is64BitProcess ? @"\x64" : string.Empty));
